export default function ExhibitorManual() {
  return (
    <div className="manual-container card">
      <div className="manual-header section-title" style={{ textAlign: 'center', marginBottom: '40px' }}>
      ...
      <div className="manual-section" style={{ marginBottom: '30px' }}>
        ...
        <div className="manual-grid" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
          <div className="info-box" style={{ background: '#f8fafc', padding: '15px', borderRadius: '8px', border: '1px solid #e2e8f0' }}>
            <h4 style={{ color: '#000', marginBottom: '10px' }}>General Information</h4>
      ...
      <div className="manual-section" style={{ marginBottom: '30px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '15px', fontSize: '14px', color: '#555', lineHeight: 1.6 }}>
          ...
          <p><strong>2. Stall Design Submission Guidelines:</strong> All exhibitors must submit stall designs in advance for approval. Designs should follow safety norms, height restrictions, and branding rules. Unauthorized structures or last-minute changes will not be permitted.</p>
          <p><strong>3. Fabrication & Setup Schedule:</strong> Stall fabrication will begin on 30th April from 12:30 PM onwards. All setup work must be completed strictly by 1st May, 10:00 PM, to ensure timely inspection and readiness.</p>
          <p><strong>4. Dismantling Guidelines:</strong> Dismantling of stalls can begin only after the exhibition ends on 3rd May. Early dismantling is strictly prohibited. Exhibitors must clear materials responsibly without causing inconvenience or damage.</p>
          <p><strong>5. Damage & Liability Policy:</strong> Exhibitors will be fully responsible for any damage caused to venue property, electrical fittings, or common areas during setup, event days, or dismantling. Any loss or damage will be chargeable, and items must be returned in proper condition after the event.</p>
          <p><strong>6. Branding & Promotional Restrictions:</strong> Any promotional activity, branding, or distribution of materials outside the allocated stall area is strictly prohibited. Violations may lead to penalties or removal from the exhibition without prior notice.</p>
          <p><strong>7. Electrical & Safety Compliance:</strong> All electrical connections must be handled by authorized personnel only. Use of substandard wiring or unsafe equipment is prohibited. Exhibitors must comply with all fire safety and venue regulations.</p>
          <p><strong>8. Entry Pass & Access Control:</strong> Exhibitors must carry valid entry passes at all times. Access to the exhibition area during setup and event days will be strictly monitored. Unauthorized personnel will not be allowed inside.</p>
          <p><strong>9. Housekeeping & Cleanliness:</strong> Exhibitors are responsible for maintaining cleanliness within their stall. Waste materials must be disposed of properly. Maintaining hygiene and professional appearance is mandatory throughout the exhibition.</p>
          <p><strong>10. Security & Valuables:</strong> While basic security will be provided, exhibitors are responsible for safeguarding their own products and valuables. Organizers will not be liable for any loss, theft, or damage during the event.</p>
          <p><strong>11. Sound & Display Regulations:</strong> Use of loudspeakers, music systems, or excessive noise is not allowed without prior approval. Displays must not disturb neighboring exhibitors or disrupt the overall exhibition environment.</p>
          <p><strong>12. Compliance & Penalties:</strong> Failure to follow any guideline may result in penalties, power disconnection, or stall cancellation. Organizers reserve the right to take necessary action to maintain discipline and event standards.</p>
          <p><strong>13. Fire Safety Details:</strong> All exhibitors must strictly adhere to fire safety regulations throughout the event. The use, storage, or display of any flammable or hazardous materials inside the exhibition area is strictly prohibited.</p>
        </div>
      </div>

      <div className="manual-section" style={{ marginBottom: '30px' }}>
        <h3 style={{ borderBottom: '2px solid #84cc16', paddingBottom: '10px', marginBottom: '15px', color: '#333' }}>
          3. Stalls Possession & Octonorm Assets
        </h3>
        <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
          <div className="info-box" style={{ background: '#fff', padding: '15px', borderRadius: '8px', border: '1px solid #e2e8f0', boxShadow: '0 1px 3px rgba(0,0,0,0.05)' }}>
            <h4 style={{ color: '#000', marginBottom: '10px' }}>Octonorm Stall Included Items</h4>
            <table style={{ width: '100%', borderCollapse: 'collapse', fontSize: '13px', textAlign: 'center' }}>
              <thead>
                <tr style={{ background: '#f1f5f9', color: '#333' }}>
                  <th style={{ padding: '8px', border: '1px solid #e2e8f0' }}>Stall Size</th>
                  <th style={{ padding: '8px', border: '1px solid #e2e8f0' }}>Chairs</th>
                  <th style={{ padding: '8px', border: '1px solid #e2e8f0' }}>Table</th>
                  <th style={{ padding: '8px', border: '1px solid #e2e8f0' }}>Light</th>
                  <th style={{ padding: '8px', border: '1px solid #e2e8f0' }}>5 AMP Plug</th>
                  <th style={{ padding: '8px', border: '1px solid #e2e8f0' }}>Dustbin</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td style={{ padding: '8px', border: '1px solid #e2e8f0' }}>3x3 mtr.</td>
                ...
                <tr>
                  <td style={{ padding: '8px', border: '1px solid #e2e8f0' }}>3x6 mtr.</td>
                  <td style={{ padding: '8px', border: '1px solid #e2e8f0' }}>3</td>
                  <td style={{ padding: '8px', border: '1px solid #e2e8f0' }}>2</td>
